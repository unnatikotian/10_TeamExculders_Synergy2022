        ...
        <div class="container">
          <button type="button" class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
            ...
            <span class="icon-bar"></span>
             ...
             <a class="brand" href="#"><img src="uploads/<?php echo $company_logo; ?>" width="23" height="23" />&nbsp; <font size="3">CRESCENT Judging Portal</font></a> 
...
<header class="jumbotron subhead" id="overview">
  <div class="container">
    <h1>Score Sheets</h1>
  <p class="lead">CRESCENT Judging Portal</p>
  </div>
</header>
<?php  } else {?>
<header class="jumbotrontabulator subhead" id="overview">
  ...
  <div class="container">
    <h1>Score Sheets</h1>
  <p class="lead">CRESCENT Judging Portal - Tabulator's Panel</p>
  </div>
</header>       
<?php } ?>
